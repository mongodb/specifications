...
TopologyType Unknown : A starting state.
...
TopologyType Sharded : A steady state. Connected to one or more mongoses.
...
TopologyType ReplicaSetNoPrimary : A starting state. The topology is definitely a replica set, but no primary is known.
...
TopologyType ReplicaSetWithPrimary : A steady state. The primary is known.
