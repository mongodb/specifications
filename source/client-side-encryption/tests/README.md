...
The spec tests format is an extension of
[transactions spec tests](https://github.com/mongodb/specifications/blob/master/source/transactions/tests/README.rst)
with some additions:
