...
authentication and drivers MUST send ``saslSupportedMechs``. If no authentication mechanism
and no credential are provided, drivers MUST continue to authenticate using the standard
authentication handshake.
